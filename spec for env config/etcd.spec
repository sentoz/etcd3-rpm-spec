...
rm -rf %{buildroot}%{_bindir}/README.md
rm -rf %{buildroot}%{_bindir}/README-%{name}ctl.md
rm -rf %{buildroot}%{_bindir}/READMEv2-%{name}ctl.md
...
- initial build 3.4.18 for Environment conf
